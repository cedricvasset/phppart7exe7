...
<html lang="fr" dir="ltr">
    ...
    <body>
        <?php if ($success == true) { ?>
            <p><?= $civility . ' ' . $lastname . ' ' .  $firstname  . ' ' . $_FILES['myfile']['name'] ?></p>
            <p><a href="indexsteph.php">retour</a></p>
        <?php } else { ?>
            <form action="indexsteph.php" method="POST" enctype="multipart/form-data">
